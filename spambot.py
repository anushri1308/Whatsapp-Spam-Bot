...
amount = 10 # Amound of times message should get spammed
delay = 0.2 # Delay in seconds between each message sent (to be safe, don't make this lower than 0.2)
contact = "Mom" # Contact to spam - this is the contact's exact name

# Creating Chrome WebDriver - this represents an instance of Chrome
options = webdriver.ChromeOptions() # ChromeOptions instance
options.add_argument('user-data-dir=C:\\ChromeProfile') # Adding argument to options - this option will make us use  # newly made Chrome Profile
...
#//*[@id="pane-side"]/div/div/div/div[8]/div/div/div[2]/div[2]/div[1]/span/span
